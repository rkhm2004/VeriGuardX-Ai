...
import { Cloud, Truck, AlertTriangle, Loader2, MapPin, Wind, Zap, ArrowRight } from "lucide-react"
...
export default function CourierAgent() {
  ...
  // --- ADDED: Hooks for Navigation and Global State ---
  const router = useRouter()
  const { updateAgentProgress, setCurrentStep: setGlobalStep } = useVerification()
  ...
  const handleComplete = async () => {
    // 1. Mark this agent as complete in the global progress bar
    updateAgentProgress('courier', 100) 
    
    // 2. Set the next active step
    setGlobalStep('provenance')
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
        ...
        <div className="flex flex-col p-8 bg-black/30">
          ...
          >
            ...
            {/* Terminal Window */}
            <div className="flex-1 bg-black/80 border border-cyan-500/30 rounded-lg p-4 font-mono text-sm overflow-hidden flex flex-col">
              <div className="text-cyan-300 mb-4">$ LOGIGUARD_AI_ACTIVATED</div>
              ...
              {result && (
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 1 }}
                  >
                    <div className="text-cyan-400 font-bold mb-6">$ ANALYSIS_COMPLETE</div>
                    ...
                    <motion.button
                      ...
                      className="w-full bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500 hover:text-black font-bold py-4 rounded border border-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.2)] hover:shadow-[0_0_30px_rgba(6,182,212,0.6)] transition-all flex items-center justify-center gap-2"
                    >
                      PROCEED TO PROVENANCE CHECK
